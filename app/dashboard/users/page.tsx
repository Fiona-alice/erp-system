    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-2 rounded-lg shadow mb-3 flex flex-wrap gap-2 items-center justify-between text-sm">
        <div className="flex gap-3">
          <button onClick={openNew} className="bg-gray-100 text-blue-700 border px-3 py-1.5 rounded-md hover:bg-gray-100">
            New
          </button>
        ...
        <input
          ...
          className="border px-3 py-1.5 rounded-md w-64"
        />
      </div>
        ...
        <div className="overflow-x-auto">
         <div className="max-h-[400px] overflow-y-auto">
          ...
          <thead className="bg-gray-100 sticky top-0 z-10">
            <tr>
              <th className="text-left p-2 border border-gray-200">Username</th>
              <th className="text-left p-2 border border-gray-200">Full Name</th>
              <th className="text-left p-2 border border-gray-200">Role</th>
              <th className="text-left p-2 border border-gray-200">Status</th>
              <th className="text-left p-2 border border-gray-200">Created</th>
            </tr>
          </thead>
          ...
          <tbody>
            {filteredUsers.map((user) => (
              ...
              >
                <td className="p-2 text-gray-700 border border-gray-200">{user.username}</td>
                <td className="p-2 text-gray-700 border border-gray-200">{user.full_name}</td>
                <td className="p-2 text-gray-700 border border-gray-200">{user.role}</td>
